      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 text-center text-balance gap-6  py-8">
        ...
        <div className="max-w-4xl text-left space-y-6">
          ...
          <p>
            ...
            and payment details when you book a flight. Additionally, we may
            collect usage data and cookies to enhance your experience.
          </p>
          <h2 className="text-2xl font-semibold">
            2. How We Use Your Information
          </h2>
          <p>
            We use your information to process bookings, improve our services,
            and provide customer support. Your data may also be used for
