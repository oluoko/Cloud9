...
export async function createFlight(preveState: unknown, formData: FormData) {
  ...
  const newFlight = await prisma.flight.create({
    data: {
      ...
      lowSeats: submission.value.lowSeats,
      middleSeats: submission.value.middleSeats,
      executiveSeats: submission.value.executiveSeats,
      lowPrice: submission.value.lowPrice,
      middlePrice: submission.value.middlePrice,
      executivePrice: submission.value.executivePrice,
